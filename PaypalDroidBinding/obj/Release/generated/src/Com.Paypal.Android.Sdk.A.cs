...
namespace Com.Paypal.Android.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='A']"
	[global::Android.Runtime.Register ("com/paypal/android/sdk/A", DoNotGenerateAcw=true)]
	public sealed partial class A : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/paypal/android/sdk/A", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='A']/constructor[@name='A' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe A ()
		...
		static IntPtr id_a;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='A']/method[@name='a' and count(parameter)=0]"
		[Register ("a", "()Ljava/lang/String;", "")]
		public unsafe string InvokeA ()
		{
			if (id_a == IntPtr.Zero)
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='A']/method[@name='a' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("a", "(Ljava/lang/String;)Ljava/lang/String;", "")]
		public unsafe string InvokeA (string p0)
		{

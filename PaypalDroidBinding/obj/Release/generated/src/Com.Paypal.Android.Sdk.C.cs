...
namespace Com.Paypal.Android.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='C']"
	[global::Android.Runtime.Register ("com/paypal/android/sdk/C", DoNotGenerateAcw=true)]
	public sealed partial class C : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/paypal/android/sdk/C", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='C']/constructor[@name='C' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe C ()
		...
		static IntPtr id_a;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='C']/method[@name='a' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='C']/method[@name='a' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"

...
namespace Com.Paypal.Android.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='cW']"
	[global::Android.Runtime.Register ("com/paypal/android/sdk/cW", DoNotGenerateAcw=true)]
	public sealed partial class CW : global::Android.Widget.ArrayAdapter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/paypal/android/sdk/cW", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CW); }
		}

		internal CW (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Ljava_util_ArrayList_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='cW']/constructor[@name='cW' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.util.ArrayList'] and parameter[3][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/util/ArrayList;I)V", "")]
		public unsafe CW (global::Android.Content.Context p0, global::System.Collections.IList p1, int p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CW)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='cW']/method[@name='a' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("a", "(I)V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='cW']/method[@name='getView' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.view.ViewGroup']]"

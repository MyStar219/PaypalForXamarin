...
namespace Com.Paypal.Android.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='L']"
	[global::Android.Runtime.Register ("com/paypal/android/sdk/L", DoNotGenerateAcw=true)]
	public sealed partial class L : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/paypal/android/sdk/L", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='L']/constructor[@name='L' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe L ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (L)) {
					SetHandle (
		...
		static IntPtr id_a;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='L']/method[@name='a' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.paypal.android.sdk']/class[@name='L']/method[@name='a' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
